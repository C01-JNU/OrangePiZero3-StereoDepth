...
int main() {
    LOG_INFO("=== 1level测试：增加描述符集布局 ===");
    LOG_INFO("测试目标：创建带有描述符集布局的计算管线");
    ...
    appInfo.pApplicationName = "Level1Test";
