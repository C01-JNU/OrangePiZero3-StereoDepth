...
int main() {
    LOG_INFO("=== 2level测试：多个描述符集绑定 ===");
    LOG_INFO("测试目标：3个绑定（2个存储缓冲区，1个uniform缓冲区）");
    ...
    appInfo.pApplicationName = "Level2Test";
    ...
    // 8. 创建描述符集布局 - 3个绑定（2个存储缓冲区，1个uniform缓冲区）
    LOG_INFO("7. 创建描述符集布局（3个绑定）...");
